  ...
  <div class="container" id="app">
    <div class="forms-container">
      <div class="signin-signup">
        <a-form ref="loginRef" :model="loginForm" :rules="loginRules" class="sign-in-form">
          ...
          <a-button type="primary" :loading="loginLoading" @click="Login()" class="btn form" round>
        ...
        <a-form ref="signUpRef" :model="signUpForm" :rules="signUpRules" class="sign-up-form">
          ...
          <!-- <div class="input-field">
            ...
            <a-form-item name="phone">
              <a-input v-model:value="signUpForm.phone" placeholder="手机号" />
            </a-form-item>
          </div> -->
          <div class="input-field">
            <i>
...
const signUpRules: Record<string, Rule[]> = {
  username: [
    {
      required: true,
      message: '请输入账号',
